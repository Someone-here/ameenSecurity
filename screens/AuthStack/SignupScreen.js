        ...
        <AuthPage>
            <View style={styles.container}>
                ...
                <View style={styles.row}>
                    <TouchableOpacity onPress={() => navigation.navigate("BusinessSignupScreen")} style={styles.selection}>
                        <Text style={styles.selectionText}>Business</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.selection} onPress={() => setVisible(true)}>
                ...
                >
                    <View style={styles.modalContainer}>
                        ...
                        <View style={styles.row}>
                            <TouchableOpacity onPress={() => navigation.navigate("GuardSignupScreen")} style={styles.selection}>
                                <Text style={styles.selectionText}>Guard</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.selection} onPress={() => navigation.navigate("StewardSignupScreen")}>
